...
public class User implements IDBObject {
	...
	sqlStatement+="Nachname="+SQLDataUtilities.getSQLDataFormat(surname)+", ";
	...
	sqlStatement+="WHERE idNutzer="+SQLDataUtilities.getSQLDataFormat(id)+";";
	return sqlStatement;
    }
	...
	if (eMail.length()==0)
	    throw new SQLException("EMAIL is a NOT NULL field.");
	String sqlStatement="INSERT INTO Nutzer (Nachname, Vorname, EMAIL, Strasse, Nr, PLZ, Ort, Land) VALUES(";
