...
public class DBConnector {
	...
	public DBConnector (String URL, int Port, String DBName, String UserName, String Password) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException
	{
		con=null;
		dbURL=URL;
		dbUsr=UserName;
