 ...
 * @author sascha
 */
public class ArticleDetailFrame extends javax.swing.JFrame implements IClientGUIListener{
    ...
    public void fillFields(Pair<Article,ReducedUserData> data, ClientCore core, boolean editableDetails) {
        if(data==null)
        {
            newArticle=true;
        ...
        if(!isUserArticle)
        {
            ...
            if(rud.getAddress()!=null)
                sellerLabel.setText(sellerLabel.getText()+" located in "+rud.getAddress());
        }
       // validate();
        //repaint();
    }
    ...
    private void initComponents() {
        ...
        grossPriceField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.00"))));

        vatField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.00"))));

        netPriceField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.00"))));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(grossPriceField, javax.swing.GroupLayout.PREFERRED_SIZE, 492, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(longDescField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel5))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(grossPriceField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel8)
                            .addComponent(netPriceField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(38, 38, 38)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel9))))
                .addGap(7, 7, 7)
                .addComponent(sellerLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        article.setWeight(Float.parseFloat(weightField.getText()));
        article.setAmount(Float.parseFloat(amountField.getText()));
        if("".equals(grossPriceField.getText()))
        {
            float vat=Float.parseFloat(vatField.getText().replace('%', ' '));
            float netPrice=Float.parseFloat(netPriceField.getText());
            float grossPrice=netPrice/(1+vat/100);
            article.setGrossPrice(grossPrice);
        }
        else
            article.setGrossPrice(Float.parseFloat(grossPriceField.getText()));
        if("".equals(vatField.getText()))
        {
            float grossPrice=Float.parseFloat(grossPriceField.getText());
            float netPrice=Float.parseFloat(netPriceField.getText());
            float vat=grossPrice/netPrice*100;
            article.setVat(vat);
        }
        else
            article.setVat(Float.parseFloat(vatField.getText()));
        if("".equals(netPriceField.getText()))
        {
            float vat=Float.parseFloat(vatField.getText().replace('%', ' '));
            float grossPrice=Float.parseFloat(grossPriceField.getText());
            ...
            article.setNetPrice(Float.parseFloat(netPriceField.getText()));
        DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
        try {
            ...
            JOptionPane.showMessageDialog(null, "Please use the format dd/MM/yyyy for the expiration date");
            return;
        }
        if(newArticle)
    ...
    public void failureAnswerReceived(Object payload) {
        JOptionPane.showMessageDialog(null, "Operation failed: "+(String)payload);
    }
