 ...
 * @author sascha
 */
public class ClientArticleListPanel extends javax.swing.JPanel implements ICSMessageEventReceiver {
     ...
     * @param parent 
     */
    public ClientArticleListPanel(User user, boolean showOffers, ClientMainFrame parent) {
        initComponents();
        this.user=user;
    ...
    private void loadOwnArticles() {
    	ArticleListMessageRequest req=new ArticleListMessageRequest(user.getId(), showOffers);
    ...
    private void detailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailButtonActionPerformed
        ...
        dialog=new JDialog();
        ClientArticleDetailPanel artPanel=new ClientArticleDetailPanel(user,art,showOffers,this);
