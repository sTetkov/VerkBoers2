 ...
 * @author sascha
 */
public class ClientLoginPanel extends javax.swing.JPanel implements
     ...
     * @param ccm
     */
    public ClientLoginPanel(User user, ClientMainFrame clientMainFrame,
	...
	if (uNameField.getText().isEmpty() || pwdField.getText().isEmpty()) {
	    JOptionPane.showMessageDialog(this,
		    "Please inser username and password.");
	    return;
	}
	...
	dialog.hide();
	user = ((LoginMessageAnswerPayload) (answer.getPayload()))
		.getUserData();
